#!/usr/bin/env python3
"""Module for simple end-to-end (E2E)
...
def log_in_wrong_password(email: str, password: str) -> None:
    """This function test logging in with wrong password.
...
def profile_logged(session_id: str) -> None:
    """This function will tests the retrieving
    profile information whilst logged in.
...
def reset_password_token(email: str) -> str:
    """The function Tests the process
    of requesting a password reset.
...
def update_password(email: str, reset_token: str, new_password: str) -> None:
    """This function Tests updating a user's password...
...
def log_in(email: str, password: str) -> str:
    """The funtion for Tests logging in...
